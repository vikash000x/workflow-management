...
team_members, team_lead, progress, priority
       ...
       member.role === 'ADMIN'
        ...
        return res.status(403).json({message: "you do not have permission to create projects in this workspace"})
    }
...
//include: { members: { include: { user: true } } }
  ...
  if(!project){
    ...
    return res.status(403).json({ message: "You do not have permission to update this project" });
        ...
        //return res.status(403).json({message: "you do not have permission to update projects in this workspace"})
    }
 ...
 export const addMembers = async(req, res)=> {
    ...
    try{
        ...
        const {email} = req.body; // array of user emails
